    ...
    postCreate: function() {
      ...
      linkValue = new RegExp("http");   //format string for link values to check with test function
        ...
        //---Global variables
              ...
              //queryBuildingTask = new QueryTask("https://arcgisdev02.tacoma.lcl/arcgis/rest/services/Test/DARTquery_WAB_PUBLIC/MapServer/24");  //TEST!! REMOVE THIS LINE AND USE THE ONE BELOW AssessorImprovement table
              queryBuildingTask = new QueryTask("https://" + webserver1 + "/rest/services/" + folder1 + "/DARTquery_WAB_PUBLIC/MapServer/24");  //Assessor Improvement table
             ...
             //End query buildings setup
              ...
              //identifyTask = new IdentifyTask("https://arcgisdev02.tacoma.lcl/arcgis/rest/services/Test/DARTquery_WAB_PUBLIC/MapServer");  //TEST!! REMOVE THIS LINE AND USE THE ONE BELOW All other layers
